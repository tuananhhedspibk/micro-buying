...
export class CreateItemMigration1697257263679 implements MigrationInterface {
    name = 'CreateItemMigration1697257263679'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`item\` (\`id\` varchar(36) NOT NULL, \`code\` varchar(255) NOT NULL, \`name\` varchar(255) NOT NULL, \`image\` varchar(255) NOT NULL, \`status\` enum ('Stocking', 'Bought') NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_ee4429a8fe2b5758456617e1ef\` (\`code\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    }
